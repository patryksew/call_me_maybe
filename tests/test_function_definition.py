...
class TestFunctionDefinitionParsing:
    ...
    def test_parse_simple_function_definition(self) -> None:
        """Parse a simple function definition from a dictionary."""
        data = {
            "name": "fn_add",
        ...
        func_def = FunctionDefinition.model_validate(data)
    ...
    def test_parse_function_definition_from_json_string(self) -> None:
        """Parse a FunctionDefinition from a JSON string."""
        json_str = '''
        {
            "name": "fn_greet",
    ...
    def test_parse_function_with_multiple_parameters(self) -> None:
        """Parse a function with multiple different parameter types."""
        data = {
            "name": "fn_process",
    ...
    def test_parse_function_with_weird_whitespaces(self) -> None:
        """Parse a function definition with extra whitespaces in the JSON string."""
        json_str = '''
        {         "name":
...
class TestFunctionDefinitionValidation:
    ...
    def test_validate_required_fields(self) -> None:
        ...
        with pytest.raises(ValidationError):
            FunctionDefinition.model_validate(incomplete_data)

    def test_validate_parameters_shape(self) -> None:
        """Verify that the nested parameter shape is preserved."""
        data = {
            "name": "fn_test",
            "description": "Test",
            "parameters": {
    ...
    def test_validate_flat_parameters_rejected(self) -> None:
        """Verify that flat parameter definitions are rejected."""
        data = {
            "name": "fn_test",
            "description": "Test",
        ...
        with pytest.raises(ValidationError):
            FunctionDefinition.model_validate(data)

    def test_validate_empty_parameters(self) -> None:
        """Verify that an empty parameters dictionary is allowed."""
        data = {
            "name": "fn_no_params",
...
class TestFunctionDefinitionsParsing:
    ...
    def test_parse_function_definitions_list(self) -> None:
    ...
    def test_parse_empty_function_definitions(self) -> None:
    ...
    def test_access_functions_property(self) -> None:
...
class TestFunctionDefinitionsValidation:
    ...
    def test_validate_all_items_in_collection(self) -> None:
    ...
    def test_validate_flat_parameters_in_collection_rejected(self) -> None:
...
class TestFunctionDefinitionsSerialization:
    ...
    def test_serialize_collection_to_json(self) -> None:
    ...
    def test_serialize_and_deserialize_collection_roundtrip(self) -> None:
